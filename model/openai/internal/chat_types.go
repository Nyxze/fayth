...
type ChatCompletionChoice struct {
	...
	FinishReason FinishReason          `json:"finish_reason"`      // Reason why the model stopped generating (e.g., "stop", "length", "tool_calls").
}
...
func (c ChatMessage) isSimpleMessage() bool {
	return len(c.Contents) == 1 && c.Contents[0].Type == TextContent
}
